...
DEST_PATH="/mnt/nepi_storage/nepi_src/nepi_engine_ws/src/nepi_engine/nepi_api"
...
echo ""
echo "Syncing ${API_NAME} from ${SOURCE_PATH} to NEPI Build Repo at:" 
...
echo ""
echo "Syncing API FOLDER ${API_NAME} from ${SOURCE_PATH} to NEPI Live Folders at:" 
echo "Destination Path ${DEST_PATH}"
echo ""
