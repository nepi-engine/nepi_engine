...
class DepthMapImgPub:
    ...
    def __init__(self):
        ...
        self.data_product = nepi_ros.get_param("~data_product",self.IMG_DATA_PRODUCT)
        ...
        self.dm_namespace = nepi_ros.get_param("~dm_namespace",backup_dm_namespace)
    ...
    def subscribeImgTopic(self):
        ...
        if img_info_dict is not None:
            ...
            pub_namespace = nepi_ros.create_namespace(bs_namespace,self.data_product)
