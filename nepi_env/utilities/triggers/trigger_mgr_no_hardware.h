...
class TriggerMgrNoHardware : public TriggerMgrBase
{
	 ...
	 */
	virtual void configureHwTrigIn(const nepi_interfaces::HwTrigInCfg::ConstPtr& cfg) override
	{
	 ...
	 * @param[in]  cfg   The configuration message
	 */
	virtual void configureHwTrigOut(const nepi_interfaces::HwTrigOutCfg::ConstPtr& cfg) override
	{
